...
# Models
MAIN_MODEL = os.environ.get("CORTEX_MAIN_MODEL", "glm-5-turbo")
SUB_MODEL  = os.environ.get("CORTEX_SUB_MODEL",  "glm-4.5-air")

# Session storage path
SESSION_DIR = Path.home() / ".cortex-code" / "projects"
