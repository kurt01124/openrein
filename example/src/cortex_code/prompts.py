...
def get_system_prompt(cwd: str, is_git: bool, model_name: str = "GLM-5-turbo") -> str:
...
You have been invoked in the following environment:
 ...
 - Is a git repository: {str(is_git).lower()}
 - Platform: {plat}
...
SUBAGENT_SYSTEM_PROMPT = (
    ...
    "to complete the task fully. Complete the task fully — don't gold-plate, but don't leave "
    "it half-done. When you complete the task, respond with a concise report covering what "
